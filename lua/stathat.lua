...
function ez_count(email, stat_name, count) 
        return http.request("http://api.stathat.com/ez", "email=" .. email .. "&stat=" .. stat_name .. "&count=" .. count)
end

function ez_value(email, stat_name, value) 
        return http.request("http://api.stathat.com/ez", "email=" .. email .. "&stat=" .. stat_name .. "&value=" .. value)
end
